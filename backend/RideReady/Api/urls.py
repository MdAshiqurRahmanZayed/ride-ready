...
urlpatterns = [
    ...
    path(
        "token/", MyTokenObtainPairView.as_view(), name="MyTokenObtainPairView"
    ),  # django simple jwt
    ...
    path(
        ...
        name="VehicleCategoryListAPIView",
    ),
    ...
    path(
        "see-all-booked/", SeeBookingListAPIView.as_view(), name="SeeBookingListAPIView"
    ),
    # Payment
    path(
        "booking/<int:vehicle_id>/payment/",
